...
Milestone 4 provides a small vanilla TypeScript and xterm.js client for the
...
URL manually; QR pairing remains a future milestone.
...
- Ctrl, Esc, Tab, arrow, Ctrl+C, and Ctrl+D helper controls remain deferred.
